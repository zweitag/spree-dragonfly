...
ActiveRecord::Schema.define(:version => 20120503131724) do
  ...
  create_table "spree_assets", :force => true do |t|
    ...
    t.string   "attachment_image_name"
  end

  add_index "spree_assets", ["attachment_uid"], :name => "index_spree_assets_on_attachment_uid"
